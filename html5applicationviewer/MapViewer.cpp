// checksum 0x313b version 0x8000b
/*
...
void Html5ApplicationViewerPrivate::addToJavaScript()
{
    ...
    m_webView->page()->mainFrame()->addToJavaScriptWindowObject(
                "googleMaps", &QGoogleMaps::instance());
}
...
void MapViewer::loadFile(const QString &fileName)
{
    m_d->m_webView->setUrl(QUrl::fromLocalFile(Html5ApplicationViewerPrivate::adjustPath(fileName)));
}

void MapViewer::loadUrl(const QUrl &url)
{
    m_d->m_webView->setUrl(url);
}

void MapViewer::setOrientation(ScreenOrientation orientation)
{
...
QGraphicsWebView *MapViewer::webView() const
{
    return m_d->m_webView;
}

#include "MapViewer.moc"
